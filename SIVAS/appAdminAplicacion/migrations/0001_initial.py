# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2018-06-25 18:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_det_iti', models.DateField(blank=True, null=True)),
                ('creado_en', models.DateTimeField(auto_now_add=True, null=True)),
                ('creado_por', models.EmailField(blank=True, max_length=255, null=True, verbose_name='Created By')),
                ('actualizado_en', models.DateTimeField(auto_now=True, null=True)),
                ('actualizado_por', models.EmailField(blank=True, max_length=255, null=True, verbose_name='Updated By')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actualizado_en', models.DateTimeField(auto_now=True, null=True)),
                ('actualizado_por', models.EmailField(blank=True, max_length=255, null=True, verbose_name='Updated By')),
                ('detalle_linea_aeropuerto', models.ForeignKey(db_column='id_detalle_linea_aeropuerto', on_delete=django.db.models.deletion.CASCADE, to='appAdminAplicacion.detalle_linea_aeropuerto')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_itinerario', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direccion_facebook', models.CharField(blank=True, max_length=50, null=True)),
                ('direccion_twitter', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero_viajero', models.CharField(max_length=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actualizado_en', models.DateTimeField(auto_now=True, null=True)),
                ('actualizado_por', models.EmailField(blank=True, max_length=255, null=True, verbose_name='Updated By')),
                ('pasajero', models.ForeignKey(db_column='id_pasajero', on_delete=django.db.models.deletion.CASCADE, to='appAdminAplicacion.pasajero')),
            ],
            options={
                'db_table': 'tarjeta',
            },
        ...
        migrations.AddField(
            model_name='detalle_reservacion',
            name='numero_viajero',
            field=models.ForeignKey(db_column='id_pasajero', on_delete=django.db.models.deletion.CASCADE, to='appAdminAplicacion.pasajero'),
        ),
        migrations.AddField(
