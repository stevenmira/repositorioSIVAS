# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2018-05-08 03:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fila', models.CharField(blank=True, max_length=1, null=True)),
        ...
        migrations.AddField(
            model_name='gateway',
            name='hangar',
            field=models.ForeignKey(db_column='id_hangar', on_delete=django.db.models.deletion.CASCADE, to='appAdminAplicacion.hangar'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='avion',
            name='tipo_avion',
            field=models.ForeignKey(db_column='id_tipo_avion', on_delete=django.db.models.deletion.CASCADE, to='appAdminAplicacion.tipo_avion'),
        ),
        migrations.AddField(
            model_name='asiento',
            name='avion',
            field=models.ForeignKey(db_column='id_avion', on_delete=django.db.models.deletion.CASCADE, to='appAdminAplicacion.avion'),
        ),
        migrations.AddField(
            model_name='asiento',
            name='tipo_cabina',
