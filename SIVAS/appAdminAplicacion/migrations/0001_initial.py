# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2018-06-07 21:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cod_iata_ciudad', models.CharField(max_length=3, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cod_iata_pais', models.CharField(max_length=2, null=True)),
                ('creado_en', models.DateTimeField(auto_now_add=True)),
                ('creado_por', models.EmailField(blank=True, max_length=255, null=True, verbose_name='Created By')),
                ('actualizado_en', models.DateTimeField(auto_now=True)),
                ('actualizado_por', models.EmailField(blank=True, max_length=255, null=True, verbose_name='Updated By')),
